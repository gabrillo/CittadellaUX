...
#define is_isoch(c) (((c) >= Key_NOBREAK_SPACE) & ((c) <= Key_y_DIAERESIS))
/*
#define is_isoch(c) (((c) == Key_NOBREAK_SPACE) || ((c) == Key_INV_EXCL_MARK) \
                  || ((c) == Key_ACUTE_ACC)     || ((c) == Key_INV_QUOT_MARK) \
                  || (((c) >= Key_SHARP_S) && ((c) <= Key_y_DIAERESIS)))
*/
