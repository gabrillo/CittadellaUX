...
static int mdop_room(char *room);
static int mdop_post(char *room, long num);
static int mdop_blog(char *user, long num);
static int mdop_link(char *link, char *label);
static int mdop_file(char *filename, unsigned long filenum, unsigned long size);
static int md_type(char *filename);

/***************************************************************************/
/***************************************************************************/

int mdop(Metadata_List *mdlist)
{
        Metadata *md;
        int n, ret = FALSE;
