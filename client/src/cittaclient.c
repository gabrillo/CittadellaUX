...
int local_client;                  /* TRUE se client locale, FALSE: remoto */
char nome[MAXLEN_UTNAME];          /* Nick name dell'utente                */
int livello;                       /* Livello di accesso dell'utente       */
char ospite;                       /* 1 se l'utente e' un ospite           */
char uflags[8];                    /* Flags modificabili dall'utente       */
char sflags[8];                    /* Flags di sistem (non modif.)         */
...
char room_type[10];
int cestino;                       /* TRUE se l'utente e` in Cestino       */
int find_vroom;                    /* TRUE se l'utente e` in Trova         */
int blog_vroom;                    /* TRUE se l'utente e` in Blog          */
...
int main(int argc, char **argv) 
{
        ...
        int ut_conn, no_rc, login_status;
