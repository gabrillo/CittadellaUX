...
int is_friend(struct dati_ut *amico, struct dati_ut *utente);
int is_enemy(struct dati_ut *nemico, struct dati_ut *utente);
...
/*
 * Restituisce 1 se *amico e' nella Friendlist di *utente, altrimenti 0.
 */
int is_friend(struct dati_ut *amico, struct dati_ut *utente)
{
        int i;
...
/*
 * Restituisce 1 se *nemico e' nella Enemylist di *utente, altrimenti 0.
 */
int is_enemy(struct dati_ut *nemico, struct dati_ut *utente)
{
        int i;
