...
struct old_urna_data
{
  ...
  struct old_voce *testa_voci;	/* voci, con i voti per ciascuna voce   */
  time_t anzianita;		/*                                      */
...
struct old_urna
{
  ...
  struct old_urna_data *data;
  struct old_urna *next;
  struct old_urna *prev;
};

struct old_urna_stat
{
...
extern struct old_urna_stat old_ustat;
extern struct old_urna *old_urna_testa;
extern struct old_urna *old_urna_ultima;	/*ultima lista creata */
